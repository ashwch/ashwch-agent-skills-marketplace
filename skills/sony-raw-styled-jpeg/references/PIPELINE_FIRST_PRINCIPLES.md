...
- `${CODEX_HOME:-$HOME/.codex}/skills/sony-raw-styled-jpeg/scripts/raw_to_styled_jpeg.swift`

### Runner

- `${CODEX_HOME:-$HOME/.codex}/skills/sony-raw-styled-jpeg/scripts/run_exact_pipeline.sh`

### Metadata validator

- `${CODEX_HOME:-$HOME/.codex}/skills/sony-raw-styled-jpeg/scripts/verify_datetime_original.swift`
...
```bash
bash ${CODEX_HOME:-$HOME/.codex}/skills/sony-raw-styled-jpeg/scripts/run_exact_pipeline.sh /path/to/arw-folder codex_output
```
...
```bash
bash ${CODEX_HOME:-$HOME/.codex}/skills/sony-raw-styled-jpeg/scripts/run_interactive_pipeline.sh
```
